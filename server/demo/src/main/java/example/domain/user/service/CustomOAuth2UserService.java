...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	private User saveOrUpdate(OAuthAttributes attributes) {
		...
		return userRepository.save(optionalUser.map(entity -> entity.update(attributes.getName(), attributes.getEmail(),attributes.getPicture())).orElse(attributes.toEntity()));
	}
}